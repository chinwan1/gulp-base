            ...
            languages: {
              TH: {
                  ...
                  <strong style="margin-top:15px;display:inline-block;">3. การจัดการคุกกี้</strong></br>
                    ...
                    อย่างไรก็ตาม บริการบางอย่างบนเว็บไซต์ของมูลนิธิเพื่อ “คนไทย” จำเป็นต้องมีการใช้คุกกี้ หากท่านปิดการทำงานคุกกี้อาจทำให้ท่านใช้งานฟังก์ชันบางอย่างหรือทั้งหมดของบริการดังกล่าวได้อย่างไม่ราบรื่น</br>
              ...
              EN: {
                  description: `In this policy, the term "Cookies" that we use refers to cookies and other similar technologies for use in electronic communications which is subject to the requirements of the Personal Data Protection Act, B.E.2562.</br>
                      ...
                      <strong style="margin-top:15px;display:inline-block;">3. How to manage Cookies</strong></br>
                        ...
                        However, some services on Khonthai Foundation’s website require the use of Cookies. Therefore, disabling Cookies may result in the inability to effectively use some or all functions of the website.</br> 
