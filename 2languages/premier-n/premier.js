window.onload = (event) => {
  ...
  CSent.inititail({
    webkit: "Google",
    consentCookieID: 41,
    imageLogo: "https://isosuitestorage.blob.core.windows.net/isosuite/f0e4c2f76c5.png",
    customStyle: ``,
            ...
            languages: {
              TH: {
                  ...
                  <strong style="margin-top:15px;display:inline-block;">2. บริษัทใช้คุกกี้อย่างไร</strong></br>
                    บริษัทจะจัดเก็บข้อมูลการเข้าเยี่ยมชม Website : <a href="https://www.premier.co.th" target="_blank">https://www.premier.co.th</a> จากผู้เข้าเยี่ยมชมทุกราย ผ่านคุกกี้หรือเทคโนโลยีที่ใกล้เคียง และบริษัทจะใช้ Cookies เพื่อวัตถุประสงค์ในการพัฒนาประสิทธิภาพในการเข้าถึงบริการของบริษัทผ่าน internet รวมถึงเพื่อให้ทราบได้ว่า ท่านมีปฏิสัมพันธ์กับเนื้อหาในเว็บไซต์ของบริษัทอย่างไร และเพื่อช่วยปรับปรุงพัฒนาประสบการณ์การใช้งานให้ดีขึ้นเมื่อท่านเข้าเยี่ยมชมเว็บไซต์ของบริษัท
                  <strong style="margin-top:15px;display:inline-block;">3. การจัดการคุกกี้</strong></br>
                    ...
                    อย่างไรก็ตาม บริการบางอย่างบนเว็บไซต์ของบริษัท พรีเมียร์ จำเป็นต้องมีการใช้คุกกี้ หากท่านปิดการทำงานคุกกี้อาจทำให้ท่านใช้งานฟังก์ชันบางอย่างหรือทั้งหมดของบริการดังกล่าวได้อย่างไม่ราบรื่น 
                  ...
                  <strong style="margin-top:15px;display:inline-block;">6. รายละเอียดการติดต่อ</strong></br>
                    หากท่านต้องการสอบถามข้อมูลเกี่ยวกับนโยบายคุกกี้ฉบับนี้ ท่านสามารถติดต่อได้ที่ <a href="mailto:DPO_PFC@pfc.premier.co.th">DPO_PFC@pfc.premier.co.th</a>`,
              ...
              EN: {
                  description: `In this policy, the term "Cookies" that we use refers to cookies and other similar technologies for use in electronic communications which is subject to the requirements of the Personal Data Protection Act, B.E.2562.</br>
                      ...
                      <strong style="margin-top:15px;display:inline-block;">2. How does the company use cookies?</strong></br>
                        We use Cookies and other similar technologies to collect data about visiting the website <a href="https://www.premier.co.th" target="_blank">https://www.premier.co.th</a> from every visitor and to enhance the efficiency of accessing the company’s services via the internet, as well as to learn how you interact with the contents in our website and to improve user experience when you visit our website. 
                      <strong style="margin-top:15px;display:inline-block;">3. How to manage Cookies</strong></br>
                        ...
                        However, some services on Premier’s website require the use of Cookies. Therefore, disabling Cookies may result in the inability to effectively use some or all functions of the website.</br>
                      ...
                      <strong style="margin-top:15px;display:inline-block;">6. Contact Information</strong></br>
                        If you have queries regarding this Cookies Policy, please contact at:<a href="mailto:DPO_PFC@pfc.premier.co.th">DPO_PFC@pfc.premier.co.th</a>
                      `,
        ...
        purposes: [
          {
            ...
            languages: {
              TH: {
                ...
                <tr>
                  <td class="td-col-1">premier.co.th</td>
