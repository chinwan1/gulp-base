...
class CookieCosent extends HTMLElement {
  ...
  renderHtml() {
						...
						<div class="fd924-model-footer">
							...
							<div class="fd924-box-powered-by">
								<a href="https://www.google.co.th/" >	
									<span class="fd924-powerd-by">${
                    storeDatafd924.state.labeltextPowerText || "Powered by"
                  }</span> <span class="fd924-powerd-link">${
      storeDatafd924.state.powerByText || "wisework"
    }<span>
								</a>
							</div>
						</div>
    ...
    this.querySelector(".fd924-text-title-header").style.color =
      ci.modalTitleColor;
    this.querySelector(".fd924-text-privacy-text").style.color =
      ci.modelSubTitleColor;
  ...
  registerEvent() {
    ...
    this.querySelector(`.fd924-btn-left`).addEventListener(
      "click",
      this.onHandeRejactAll.bind(this)
    );
    this.querySelector(`.fd924-btn-right`).addEventListener(
      "click",
      this.onHandeConfirmAll.bind(this)
    );
  }
}
