        ...
        purposes: [
          {
            description: `Browsers' Cookies In this policy, the term “cookies” we use to refer to cookies and other similar technologies. for use in electronic communication which is under the requirements of the Personal Data Protection Act B.E. 2562</br>
                  ...
                  The company will collect information about visiting the Website : https://www.premier-technology.co.th/index.php  from visitorsAll through cookies or similar technologies. and the company will use cookies for the benefit to improve the efficiency of accessing the company's services via the internet, including to know that How do you interact with the content on the Company's website? and to help improve the user experience when you visit our website.</br>
                  ...
                  However, some services on the he Premier Technology PCL's website, require the use of cookies. If you disable cookies It may cause you to have difficulty using some or all of the functions of the Service.</br>
