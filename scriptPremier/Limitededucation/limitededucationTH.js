...
script.onload = function () {
  CSent.inititail({
    ...
    preview: false,
    imageLogo:
      "https://isosuitestorage.blob.core.windows.net/isosuite/eKU2CSkpwK.png",
    categories: [
      {
        id: 1,
        ...
        purposes: [
          {
            description: `ในนโยบายนี้ คำว่า “คุกกี้” ที่เราใช้จะหมายถึงคุกกี้และเทคโนโลยีอื่น ๆ ที่คล้ายคลึงกัน  เพื่อใช้ในการติดต่อสื่อสารทางอิเล็กทรอนิกส์ ซึ่งอยู่ภายใต้ข้อกำหนดตาม พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562</br>
                  ...
                  บริษัทจะจัดเก็บข้อมูลการเข้าเยี่ยมชม Website : https://www.limitededucation.org  จากผู้เข้าเยี่ยมชม
                  ...
                  อย่างไรก็ตามบริการบางอย่างบนเว็บไซต์ของ Limited Education จำเป็นต้องมีการใช้งานคุกกี้ หากท่านปิดการทำงานคุกกี้ อาจทำให้ท่านใช้งานฟังก์ชันบางอย่างหรือทั้งหมดของบริการดังกล่าวได้อย่างไม่ราบรื่น</br>
        ...
        purposes: [
          {
            ...
            description:
              ...
              <table style="margin-top:20px;">
                ...
                <tr>
                  <td class="td-col-1">limitededucation.org</td>
                  <td class="td-col-2">ARRAffinity</td>
                  <td>First-party</td>
                </tr>
                <tr>
                  <td class="td-col-1">limitededucation.org</td>
                  <td class="td-col-2">ARRAffinitySameSite</td>
                  <td>First-party</td>
                </tr>
              </table>
              `,
